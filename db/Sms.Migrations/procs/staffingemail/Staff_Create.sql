CREATE OR ALTER PROCEDURE dbo.Staff_Create
    ...
    @Route nvarchar(80), @AvatarHue int, @EmployeeCode nvarchar(64) = NULL, @Email nvarchar(256) = NULL
AS
BEGIN
    SET NOCOUNT ON;
    ...
    INSERT dbo.Staff (Id, TenantId, Name, Gender, Role, Category, Department, Phone, Shift, Route, AvatarHue, EmployeeCode, Email)
    VALUES (@Id, @TenantId, @Name, @Gender, @Role, @Category, @Department, @Phone, @Shift, @Route, ISNULL(@AvatarHue, 0), @EmployeeCode, @Email);
